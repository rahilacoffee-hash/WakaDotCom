...
export default function Contact() {
  return (
    <section id="contact" className="bg-[#F4F8FF] py-24 sm:py-28 overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="max-w-2xl"
        >
          <span className="inline-flex items-center gap-2 bg-[#E5F1FC] text-[#1769C2] text-xs font-bold px-4 py-2 rounded-full">
            <span className="w-1.5 h-1.5 rounded-full bg-[#1769C2] animate-pulse" />
            Get in touch
          </span>
        ...
        >
          ...
          {/* Left — blue panel */}
          <div className="relative md:col-span-2 bg-gradient-to-br from-[#1769C2] to-[#1772d4] p-8 sm:p-10 flex flex-col justify-between overflow-hidden">
            ...
            {channels.map((c, i) => (
              <a
                ...
                className={`
                  ...
                  transition-colors duration-300 hover:bg-[#EEF7FF]
                  ${i !== channels.length - 1 ? "border-b border-black/5" : ""}
                `}
              >
                <div className="w-11 h-11 flex-shrink-0 rounded-full bg-[#1769C2] text-[#fff] flex items-center justify-center text-lg group-hover:bg-[#1769C2] group-hover:text-white transition-colors duration-300">
                  {c.icon}
                </div>
