        ...
        >
          ...
          <div
            className="
              ...
              font-semibold
              text-[#1769C2]
              shadow-[0_5px_20px_rgba(23,105,194,0.06)]
              sm:text-sm
            "
          >
                ...
                <button
                  ...
                  className={`
                    ...
                    ${
                      activePage === index
                        ? "w-10 bg-[#1769C2]"
                        : "w-5 bg-[#1769C2]/20 hover:bg-[#1769C2]/40"
                    }
                  `}
                />
              ))}
  ...
  return (
    <button
      ...
      className="
        ...
        bg-white
        text-[#1769C2]
        shadow-[0_8px_25px_rgba(23,105,194,0.08)]
        transition-all
        duration-300
        hover:-translate-y-0.5
        hover:bg-[#1769C2]
        hover:text-white
        hover:shadow-[0_10px_30px_rgba(23,105,194,0.2)]
        active:scale-95
      "
    >
      {children}
  ...
  return (
    <motion.article
      ...
      className={`
        ...
        rounded-[28px]
        bg-[#DDEEFF]
        shadow-[0_18px_50px_rgba(23,105,194,0.08)]
        transition-shadow
        duration-500
        hover:shadow-[0_25px_65px_rgba(23,105,194,0.16)]
        ${
          mobile
            ? "h-[360px] w-full"
            : "h-[280px] w-full"
      ...
      >
        ...
        <div
          className="
            ...
            border-[#1769C2]
            bg-white
            shadow-[0_5px_15px_rgba(23,105,194,0.12)]
          "
        >
          <FaCog
            className="
