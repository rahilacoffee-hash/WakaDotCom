...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-[#5BA5F5]" />
      ...
      >
            ...
            >
              ...
              <button
                ...
                className="
                  ...
                  duration-300
                  hover:bg-[#0F5EAF]
                  hover:shadow-[0_10px_30px_rgba(23,105,194,0.35)]
                  active:scale-[0.98]
                "
              >
        ...
        >
          ...
          <p
            ...
            "
          >
            © {new Date().getFullYear()} SmartFixer. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
