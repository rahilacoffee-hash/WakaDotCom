...
export default function Contact() {
  return (
    <section
      id="contact"
      className="relative scroll-mt-20 overflow-hidden bg-[#FEEBEC] py-24 sm:py-28"
    >
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="max-w-2xl"
        >
          <span className="inline-flex items-center gap-2 bg-[#FCF3F6] text-[#E30613] text-xs font-bold px-4 py-2 rounded-full">
        ...
        >
          ...
          {/* Left — blue panel */}
          <div className="relative md:col-span-2 bg-gradient-to-br from-[#E30613] to-[#E30613] p-8 sm:p-10 flex flex-col justify-between overflow-hidden">
            ...
            {channels.map((c, i) => (
              <a
                ...
                className={`
                  ...
                  transition-colors duration-300 hover:bg-[#FCF3F6]
                  ${i !== channels.length - 1 ? "border-b border-black/5" : ""}
                `}
              >
                <div className="w-11 h-11 flex-shrink-0 rounded-full bg-[#E30613] text-[#fff] flex items-center justify-center text-lg group-hover:bg-[#E30613] group-hover:text-white transition-colors duration-300">
                  {c.icon}
                </div>
