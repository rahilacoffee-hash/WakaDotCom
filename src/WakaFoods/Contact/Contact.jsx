    ...
    <section id="contact" className="bg-[#FCF3F6] py-24 sm:py-28 overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="max-w-2xl"
        >
          <span className="inline-flex items-center gap-2 bg-[#FCF3F6] text-[#902141] text-xs font-bold px-4 py-2 rounded-full">
            <span className="w-1.5 h-1.5 rounded-full bg-[#902141] animate-pulse" />
            Get in touch
          </span>
        ...
        >
          ...
          {/* Left — blue panel */}
          <div className="relative md:col-span-2 bg-gradient-to-br from-[#902141] to-[#902141] p-8 sm:p-10 flex flex-col justify-between overflow-hidden">
          ...
          <div className="md:col-span-3 bg-white">
            {channels.map((c, i) => (
              <a
                ...
                `}
              >
                <div className="w-11 h-11 flex-shrink-0 rounded-full bg-[#902141] text-[#fff] flex items-center justify-center text-lg group-hover:bg-[#902141] group-hover:text-white transition-colors duration-300">
                  {c.icon}
                </div>
